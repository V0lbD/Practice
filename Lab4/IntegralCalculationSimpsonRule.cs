...
public class IntegralCalculationSimpsonRule : IIntegralCalculation
{
    ...
    public (double, int) IntegralCalculation(IIntegralCalculation.Integrand integrand, double lowerBound, double highBound, double eps)
    {
        ...
        return new (result, iterationNumber);
    }
}